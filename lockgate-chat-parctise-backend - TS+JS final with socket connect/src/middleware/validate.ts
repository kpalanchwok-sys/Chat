...
// ─── Groups ───────────────────────────────────────────────────────────────────
const createGroupRules: ValidationChain[] = [
  body("name")
    .trim()
  ...
  body("type")
    .optional()
    .isIn(["public", "private"])
    .withMessage("Type: public or private"),
  body("maxMembers")
    .optional()
    .isInt({ min: 2, max: 5000 })
    .withMessage("maxMembers: 2–5000"),
  validate as any,
];

const updateGroupRules: ValidationChain[] = [
  body("name")
    .optional()
    .trim()
    .isLength({ min: 2, max: 60 })
...
// ─── Messages ─────────────────────────────────────────────────────────────────
const sendMessageRules: ValidationChain[] = [
  body("content")
    .optional()
    .isLength({ max: 4000 })
    .withMessage("Max 4000 characters"),
  body("type")
    .optional()
    .isIn(["text", "image", "file", "reply"])
...
const editMessageRules: ValidationChain[] = [
  body("content")
    .trim()
    .notEmpty()
...
// ─── Params ───────────────────────────────────────────────────────────────────
const mongoId = (name: string): ValidationChain[] => [
